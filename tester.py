...
def setup_markers():
        ...
        markers.markers.append(cart_marker)
        markers.markers.append(sac_marker)
        markers.markers.append(score_marker)
        markers.markers.append(dir_marker)###arrow###

        return [mass_marker, link_marker, cart_marker, sac_marker,score_marker, dir_marker, markers]
    
[mass,link,cart,sac,score,dirs,markers]=setup_markers()